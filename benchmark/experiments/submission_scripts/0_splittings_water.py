...
# Quick test on water, since we can simulate this much faster than DHFR...
import os
...
from benchmark.testsystems import flexible_waterbox, waterbox_constrained
...
systems = {"WaterBox (unconstrained)": flexible_waterbox,
...
experiment_name = "0_splittings_water"
experiments = []
i = 0
